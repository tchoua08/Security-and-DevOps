...
public class CartController {
	...
	public ResponseEntity<Cart> addTocart(@RequestBody ModifyCartRequest request, Authentication authentication) {
		if (!ownsRequest(request, authentication)) {
	...
	private boolean ownsRequest(ModifyCartRequest request, Authentication authentication) {
		return request != null
			&& authentication != null
			&& authentication.getName().equals(request.getUsername());
	}
